...
import { DribbbleIcon, GithubIcon, LinkedinIcon, MoonIcon, SunIcon, TwitterIcon } from "@/src/components/Icons";
  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center"> 
            ...
            <a href={siteMetadata.github} className="inline-block w-9 h-9 mr-4"><GithubIcon   className="hover:scale-125 transition-all ease duration-200 dark:fill-light"/> </a>
